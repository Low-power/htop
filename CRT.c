...
int CRT_colorSchemes[LAST_COLORSCHEME][LAST_COLORELEMENT] = {
   [COLORSCHEME_DEFAULT] = {
      ...
      [PROCESS_KERNEL_PROCESS] = ColorPair(Yellow,Black),
      ...
      [MEMORY_ZFS_ARC] = ColorPair(Magenta,Black),
   ...
   [COLORSCHEME_BLACKONWHITE] = {
      ...
      [PROCESS_KERNEL_PROCESS] = ColorPair(Magenta,White),
      ...
      [MEMORY_ZFS_ARC] = ColorPair(Magenta,White),
   ...
   [COLORSCHEME_LIGHTTERMINAL] = {
      ...
      [PROCESS_HIGH_PRIORITY] = ColorPair(Red,Black),
      [PROCESS_LOW_PRIORITY] = ColorPair(Green,Black),
      [PROCESS_KERNEL_PROCESS] = ColorPair(Magenta,Black),
   ...
   [COLORSCHEME_MIDNIGHT] = {
      ...
      [PROCESS_KERNEL_PROCESS] = ColorPair(Yellow,Blue),
      ...
      [MEMORY_ZFS_ARC] = ColorPair(Magenta,Blue),
   ...
   [COLORSCHEME_BLACKNIGHT] = {
      ...
      [PROCESS_TREE] = ColorPair(Cyan,Black),
      [PROCESS_KERNEL_PROCESS] = ColorPair(Red,Black),
      [PROCESS_THREAD] = ColorPair(Green,Black),
      [PROCESS_THREAD_BASENAME] = A_BOLD | ColorPair(Blue,Black),
      [PROCESS_R_STATE] = ColorPair(Green,Black),
      [PROCESS_D_STATE] = A_BOLD | ColorPair(Red,Black),
