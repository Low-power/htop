...
typedef enum {
   ...
   HTOP_HIGH_PERCENT_COLOR,
   HTOP_MEDIUM_PERCENT_COLOR,
   HTOP_LOW_PERCENT_COLOR,
...
int CRT_colorSchemes[LAST_COLORSCHEME][LAST_COLORELEMENT] = {
   [DEFAULT_COLOR_SCHEME] = {
      ...
      [HTOP_HIGH_PERCENT_COLOR] = A_BOLD | ColorPair(Red,Black),
      [HTOP_MEDIUM_PERCENT_COLOR] = A_BOLD | ColorPair(Magenta,Black),
      [HTOP_LOW_PERCENT_COLOR] = A_BOLD | ColorPair(Green,Black),
   ...
   [MONOCHROME_COLOR_SCHEME] = {
      ...
      [HTOP_HIGH_PERCENT_COLOR] = A_BOLD,
      [HTOP_MEDIUM_PERCENT_COLOR] = A_NORMAL,
      [HTOP_LOW_PERCENT_COLOR] = A_NORMAL,
   ...
   [BLACKONWHITE_COLOR_SCHEME] = {
      ...
      [HTOP_HIGH_PERCENT_COLOR] = ColorPair(Red,White),
      [HTOP_MEDIUM_PERCENT_COLOR] = ColorPair(Magenta,White),
      [HTOP_LOW_PERCENT_COLOR] =  ColorPair(Green,White),
   ...
   [LIGHTTERMINAL_COLOR_SCHEME] = {
      ...
      [HTOP_HIGH_PERCENT_COLOR] = ColorPair(Red,Black),
      [HTOP_MEDIUM_PERCENT_COLOR] = ColorPair(Magenta,Black),
      [HTOP_LOW_PERCENT_COLOR] =  ColorPair(Green,Black),
   ...
   [BLACKNIGHT_COLOR_SCHEME] = {
      ...
      [HTOP_LARGE_NUMBER_COLOR] = A_BOLD | ColorPair(Red,Black),
      [HTOP_HIGH_PERCENT_COLOR] = A_BOLD | ColorPair(Red,Black),
      [HTOP_MEDIUM_PERCENT_COLOR] = ColorPair(Yellow,Black),
      [HTOP_LOW_PERCENT_COLOR] =  ColorPair(Green,Black),
      [HTOP_METER_TEXT_COLOR] = ColorPair(Cyan,Black),
...
#define COLOR_ELEMENT_NAME(KEY) [HTOP_##KEY##_COLOR] = { #KEY "=", sizeof #KEY }
	...
	COLOR_ELEMENT_NAME(HIGH_PERCENT),
	COLOR_ELEMENT_NAME(MEDIUM_PERCENT),
	COLOR_ELEMENT_NAME(LOW_PERCENT),
